...
class UserRepository extends ServiceEntityRepository
{
    ...
    {
        return new User((string) Uuid::uuid4(), $userDto->getEmail(), ['ROLE_USER'], $userDto->getFirstName(), $userDto->getLastName(), 0, new \DateTime());
    }

    public function createAdmin(CreateUserDto $userDto): User
    {
        return new User((string) Uuid::uuid4(), $userDto->getEmail(), ['ROLE_ADMIN'], $userDto->getFirstName(), $userDto->getLastName(), 0, new \DateTime());
    }
}
